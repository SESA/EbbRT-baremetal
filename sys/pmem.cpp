...
// bool operator<(const page_range &lhs, const page_range &rhs) noexcept {
//   return &lhs < &rhs;
// }
...
// free_pages __attribute__((init_priority(FREEPAGE_INIT_PRIORITY)));
...
void ebbrt::pmem::init() {
  ...
  std::memcpy(memmap_buffer, reinterpret_cast<void *>(saved_mbi.memory_map_address),
         memmap_length);
